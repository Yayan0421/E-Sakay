      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <div className="inline-block px-3 py-1.5 bg-blue-100 rounded-full mb-3 sm:mb-4">
            <span className="text-blue-700 font-bold text-xs sm:text-sm">Simple Steps</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-1 leading-snug">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 w-full">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="inline-block px-2 py-1 bg-gray-200 rounded-full mb-2 text-xs font-bold text-gray-700">
              STEP 01
            </div>
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-1.5 sm:mb-2">Open the App</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug px-1">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-1.5 sm:mb-2">Choose Your Ride</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug px-1">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-1.5 sm:mb-2">Track in Real-Time</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug px-1">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-1.5 sm:mb-2">Arrive & Pay</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-snug px-1">
